...
username = ["Brice", "Matthieu", "David", "Alex", "Cataline", "Momo", "Quentin", "Antoine", "Thibault", "Pedro", "Marion", "Alice", "Arthur", "Anais", "Lorena", "Anaelle", "Charlotte", "Mathilde", "Anne" ]
first_name = ["Brice", "Matthieu", "David", "Alex", "Cataline", "Momo", "Quentin", "Antoine", "Thibault", "Pedro", "Marion", "Alice", "Arthur", "Anais", "Lorena", "Anaelle", "Charlotte", "Mathilde", "Anne" ]
last_name = ["Palau", "Gerard", "Cali", "Houston", "Manwel", "Siroté", "Ricard", "Gin", "Tonic", "Calster", "Chouanneau", "Chevalier", "Leloup", "Turbak", "Lieber", "Parizon", "De Turkheim", "Ledys", "Ferron" ]
email = ["brice@gmail.com", "matthieu@gmail.com", "david@gmail.com", "alex@gmail.com", "cataline@gmail.com", "momo@gmail.com", "quentin@gmail.com", "antoine@gmail.com", "thibault@gmail.com", "pedro@gmail.com", "marion@gmail.com", "alice@gmail.com", "arthur@gmail.com", "anais@gmail.com", "lorena@gmail.com", "anaelle@gmail.com", "charlotte@gmail.com", "mathilde@gmail.com", "anne@gmail.com" ]
...
bio = ["Chef Heinz Beck is perhaps best known for being the man behind Rome’s only three-Michelin-starred restaurant, La Pergola.",
  ...
  "Another renowned French chef, Pierre Gagnaire has spent his 40-year career collecting Michelin stars. Growing up in his family's Michelin-star kitchen, he received his first star when he was just 26 and hasn't stopped since.",
  "As the world's third most decorated Michelin star chef, Martin Berasategui currently has twelve stars under his belt, more than any other Spanish chef.",
  "Yannick Alleno directs eighteen restaurants across the world. His Alléno Paris au Pavillon Ledoyen is one of the oldest restaurants in Paris, situated in the Champs – Élysées gardens.",
  "Let's hear it for the ladies! Anne-Sophie Pic is the female chef with the most Michelin stars, holding eight stars across her five restaurants.",
  ...
  "The Michelin guide might not be the ultimate honour amongst chefs in the United States, but Thomas Keller has gone about setting a fine example.",
  ...
  "Since its opening, Yamamoto's Tokyo restaurant Ryugin has become became a destination for other culinary geniuses, including Joël Robuchon.",
  "Multi-award winning Swiss Chef, Andreas Caminada, started his career as a humble pastry chef.",
  "Heston Blumenthal needs little introduction. Arguably one of the most famous chefs in the world, this celebrity chef-proprietor holds 6 Michelin stars.",
  "Yet another Japanese chef on the list, Masahiro Yoshitake has managed to rack up six Michelin stars with just two restaurants. ",
  "Chef Heinz Beck is perhaps best known for being the man behind Rome's only three-Michelin-starred restaurant, La Pergola.",
  "At 24, Jordi Cruz became the youngest chef in Spain and the second youngest in the world to receive a Michelin star.",
  ...
  "Quique Dacosta found himself in the world of food purely by chance when he started working in the El Poblet restaurant at the age of 17.",
  "Joël Robuchon, widely known as the 'Chef of the Century,' passed away on 6 August 2018. At the time he was decorated with 28 stars, more than any other chef in the world.",
  "At 24, Jordi Cruz became the youngest chef in Spain and the second youngest in the world to receive a Michelin star."]
